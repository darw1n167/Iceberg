    ...
    <header className='global-nav component'>
        <div className="top-nav">
            <div className="nav-logo-div">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" data-supported-dps="24x24" fill="currentColor" className="nav-logo mercado-match" width="41" height="41" focusable="false">
        ...
        <div className='inner-search-box'>
            ...
            <div className="nav-links">
                <div className="home">
                    <svg className="svglinks" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" data-supported-dps="24x24" fill="currentColor" class="mercado-match" width="24" height="24" focusable="false">
